...
saturation = MichaelisMentenEffect(
    ...
    half_saturation_prior=dist.HalfNormal(80000)
)
...
saturation.fit(y, X[["ad_spend_search"]])
predict_data = saturation.transform(X[["ad_spend_search"]], fh=fh)

with numpyro.handlers.seed(rng_seed=42):
    predict = saturation.predict(predict_data)

fig, ax = plt.subplots()
ax.scatter(X[["ad_spend_search"]], predict)
fig.show()
```
