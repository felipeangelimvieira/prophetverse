# BudgetOptimizer { #prophetverse.budget_optimization.optimizer.BudgetOptimizer }

```python
budget_optimization.optimizer.BudgetOptimizer(
    self,
    objective,
    constraints,
...
| Name | Description |
| --- | --- |
| [wrap_func_with_inv_transform](#prophetverse.budget_optimization.optimizer.BudgetOptimizer.wrap_func_with_inv_transform) | Wrap a function with parametrization inverse transform |

### wrap_func_with_inv_transform { #prophetverse.budget_optimization.optimizer.BudgetOptimizer.wrap_func_with_inv_transform }
