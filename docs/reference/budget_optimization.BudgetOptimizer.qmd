# budget_optimization.BudgetOptimizer { #prophetverse.experimental.budget_optimization.BudgetOptimizer }

```python
experimental.budget_optimization.BudgetOptimizer(
    self,
    objective,
    constraints,
...
| Name | Description |
| --- | --- |
| [wrap_func_with_inv_transform](#prophetverse.experimental.budget_optimization.BudgetOptimizer.wrap_func_with_inv_transform) | Wrap a function with parametrization inverse transform |

### wrap_func_with_inv_transform { #prophetverse.experimental.budget_optimization.BudgetOptimizer.wrap_func_with_inv_transform }

```python
experimental.budget_optimization.BudgetOptimizer.wrap_func_with_inv_transform(
    fun,
)
```
